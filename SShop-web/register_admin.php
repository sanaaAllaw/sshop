	...
	<div class="dreamcrub">
		...
		<div class="registration-grids">
			<div class="reg-form">
				<div class="reg">
                <?php 
                   $adminuser=getadminuserPass();
                   $adminpass=getadminuserPass();
                   ?>
					 <p>Welcome, please enter the following admin details to continue.</p><p style="font-size: 20px;font-style: italic;"><a href="logout.php">Please Logout and login again</a></p>
					 ...
					 <form method="POST" action="php/insertClient.php">
						...
						<ul>
							 ...
							 <li><input type="text" value="<?php echo $adminuser;?>" name="username" id="username" required="" onkeyup="checkUserNameExistance();"></li>
                             <li><label id="lblusercheck" ></label></li>
						 </ul>
						 <ul>
							 <li class="text-info">Password: </li>
							 <li><input type="text" value="<?php echo $adminpass;?>" name="password" id="password" required=""></li>
						 </ul>
						 <ul>
							 <li class="text-info">Re-enter Password:</li>
							 <li><input type="text" value="" name="rpassword" required="" id="rpassword" onkeyup="checkPassword();"></li>
