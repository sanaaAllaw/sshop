...
public class Home extends Application {
    ...
    //    Button btnPUR =new Button("Purchase");btnPUR.setPrefWidth(170);btnPUR.setId("rich-blue");
        ...
        Button btnRate =new Button("Movements");btnRate.setPrefWidth(170);btnRate.setId("rich-blue");
     ...
     //   Button btnEMP =new Button("Operator");btnEMP.setPrefWidth(170);btnEMP.setId("rich-blue");
       //btnEMP.setGraphic(new ImageView(new Image(getClass().getResourceAsStream("/pictures/oper.png"))));
        Button btnPRD =new Button("Stock Card");btnPRD.setPrefWidth(170);btnPRD.setId("rich-blue");
       ...
       btnsett.setGraphic(new ImageView(new Image(getClass().getResourceAsStream("/pictures/settings.png"))));
        ...
        Button btndash =new Button("DashBoard");btndash.setPrefWidth(170);btndash.setId("rich-blue");
        btndash.setGraphic(new ImageView(new Image(getClass().getResourceAsStream("/pictures/Office-Customer-Male-Light-icon.png"))));
      ...
      //  grid1.add(btnPUR, 1, 7);
       ...
       // grid1.add(btnreport, 1, 13);
        ...
        btndash.setOnAction((ActionEvent event) -> {
             dashboard dash1=new dashboard();
             dash1.start(Constantes.Stagesdash);
        });
        btnITM.setOnAction((ActionEvent event) -> {
             addItems item1=new addItems();
