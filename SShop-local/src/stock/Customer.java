...
public class Customer extends Application {
    ...
    if(file != null) {
        ...
        Label l4=new Label("Street address ");
       ...
       Label l7=new Label("Fax");
        ...
        for (String countryCode : locales) {
         ...
         c1.getSelectionModel().select("Lebanon");
       ...
       /* c2.getSelectionModel().selectFirst();
        ...
        save.setOnAction((event) -> {
         ...
         idcount=idcount+1;
             data.add(new Person(String.valueOf(idcount),fname,lname, company, stt1,city,fax,phone,country));
          String insertSQL = "INSERT INTO `customer`(`fname`, `lname`, `company`, "
                  + "`phone`, `str1`,  `city`,  `country`, `fax`,  `picture`)"
                  + " VALUES (?,?,?,?,?,?,?,?,?)";
      ...
      grid1.add(c1, 4, 5);
        ...
        des.getChildren().addAll(v1,dess);
        
        Scene scene = new Scene(new Group());
        stage.setTitle("Customer");
        Rectangle2D primaryScreenBounds = Screen.getPrimary().getVisualBounds();
        double widthVar=(Constantes.primScreenBounds.getWidth()-200-10)/12;
      ...
      /*  stage.setX(primaryScreenBounds.getMinX());
       ...
       // idcol.setCellFactory(cellFactory);
        ...
        table.setItems(data);
        table.getColumns().addAll(idcol,firstNameCol, st1,st2,st3,st4,st6,st7,st10);
...
//  t10.setText("");
 // t11.setText("");
    ...
    public static class Person {
      ...
      //  private final SimpleStringProperty type;
        ...
        private Person(String IDvar,String fName, String lName, String varcompany,String varstadd1,String varcity
                ,String varfax,String varphone,String varcountry
        ) {
    ...
    class EditingCell extends TableCell<Person, String> {
        ...
        String selectSQL = "UPDATE `customer` SET `fname`=?,`lname`=?,`company`=?,`phone`=?,`str1`=?,`city`=?,"
                + "`country`=?,`fax`=? WHERE idcust=?";
        ...
        try {
         ...
         //   preparedStatement.setString(9, p.getZip());
            ...
            preparedStatement.setString(8, p.getFax());
         //   preparedStatement.setString(12, p.getType());
            preparedStatement.setInt(9,Integer.parseInt(p.getID()));
    ...
    void selectCustomerFrom(){
        ...
        try {
            ...
            while (rs.next()) {
               idcount=idcount;
              data.add(new Person(String.valueOf(rs.getInt("idcust")),rs.getString("fname"), rs.getString("lname"), 
                      rs.getString("company"), rs.getString("str1"), 
                      rs.getString("city"), rs.getString("fax"), rs.getString("phone"),
