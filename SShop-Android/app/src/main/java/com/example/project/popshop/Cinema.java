...
public class Cinema extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pdLoading = new ProgressDialog(Cinema.this);
    ...
    public void getData() {
        class GetDataJSON extends AsyncTask<Void, Void, String> {
            ...
            protected String doInBackground(Void... params) {
                String result = null;
                try {
                    String link = "http://"+functions.ipaddress+"/OnlineShopService/selectCinema.php";
    ...
    protected void showList() {
        try {
            ...
            adapter = new ListViewAdapter1(this, arraylist);
            pdLoading.dismiss();
            listComp.setAdapter(adapter);

        } catch (JSONException e) {
            Toast.makeText(Cinema.this, "no internet connection",
    ...
    public void onBackPressed() {
        finish();
        Intent Homevar = new Intent(Cinema.this, Home.class);
