...
public class Points extends AppCompatActivity {
    ...
    static ArrayList<String> itemsvar= new ArrayList<>();
    static ArrayList<String> pricesvar=new ArrayList<>();
    static ArrayList<String> qtyvar=new ArrayList<>();
    static ArrayList<String> DateVar=new ArrayList<>();
    ...
    pdLoading = new ProgressDialog(Points.this);
    ...
    public void getData() {
        class GetDataJSON extends AsyncTask<Void, Void, String> {
            ...
            protected String doInBackground(Void... params) {
                String result = null;
                try {
                    String link = "http://"+functions.ipaddress+"/OnlineShopService/selectComp.php";
                   //String data = URLEncoder.encode("q1", "UTF-8") + "=" + URLEncoder.encode(country, "UTF-8");
    ...
    protected void showList() {
        try {
            ...
            for (int i = 0; i < peoples.length(); i++) {
                ...
                country[i] = "";
                population[i] = c.getString(TAG_TEL);
            ...
            Toast.makeText(Points.this, "no internet connection",
    ...
    public void onBackPressed() {
        finish();
        Intent Homevar = new Intent(Points.this, Home.class);
